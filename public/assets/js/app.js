...
__webpack_require__(/*! ./mercadopago */ "./resources/js/mercadopago.js");
...
(function ($) {
  ...
  $(".sessoes select").on("change", function (e) {
    ...
    var id = $(this).val();
    var regularPrice = $('#product-price-' + productId).find('input[name=price]');
    var regularPriceView = $('#product-price-' + productId).find('.view');
    var specialPrice = $('#product-price-' + productId).find('.special-price .price input[name=price]');
    var specialPriceView = $('#product-price-' + productId).find('.special-price .price .money.view');
    $.ajax({
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
  ...
  $('.cep').mask('00000-000');
  $('.number_cpf').mask('000.000.000-00', {
    reverse: true
  });
  ...
  callbacks: {
    ...
    onPaymentMethodsReceived: function onPaymentMethodsReceived(error, paymentMethods) {
      if (error) {
        ...
        arrayPayment.forEach(function (paymentMethods) {
    ...
    onCardTokenReceived: function onCardTokenReceived(error, token) {
      if (error) {
        ...
        arrayError.forEach(function (error) {
...
(function () {
  var _getIdentificationTypes = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var identificationTypes, docTypeElement;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            docTypeElement = document.getElementById('docType');
  ...
  function getIdentificationTypes() {
    return _getIdentificationTypes.apply(this, arguments);
  }
...
__webpack_require__(/*! C:\xampp\htdocs\be\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\be\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\be\resources\sass\admin\edit.scss */"./resources/sass/admin/edit.scss");
