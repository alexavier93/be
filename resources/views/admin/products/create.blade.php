                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="price"
                                    ...
                                    value="{{ old('price') }}" placeholder="R$ 0,00">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="old_price"
                                    class="form-control money @error('old_price') is-invalid @enderror"
                                    value="{{ old('old_price') }}" placeholder="R$ 0,00">
                                @error('old_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="new_price"
                                    class="form-control money @error('new_price') is-invalid @enderror"
                                    value="{{ old('new_price') }}" placeholder="R$ 0,00">
                                @error('new_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="discount"
                                    class="form-control numero @error('discount') is-invalid @enderror"
                                    value="{{ old('discount') }}">
                                @error('discount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
